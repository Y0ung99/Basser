    ...
    <section className='p-8 pt-4 flex flex-col'>
      ...
      <div className='flex flex-col border-b border-gray-300 pb-8 md:flex-row md:gap-4'>
        <div className='flex flex-col basis-1/2 pt-4 relative'>
          ...
          <input className={STYLE_INPUT} required onChange={handleChange} value={form.senderAddress} type="text" name='senderAddress' placeholder='주소'/>
          ...
          <input className={STYLE_INPUT} onChange={handleChange} value={form.senderRequest} type="text" name='senderRequest' placeholder='요청사항'/>
        </div>
        <div className='flex flex-col basis-1/2 pt-4 relative'>
          ...
          <input className={STYLE_INPUT} required onChange={handleChange} value={form.receiverAddress} type="text" name='receiverAddress' placeholder='주소'/>
          ...
          <input className={STYLE_INPUT} onChange={handleChange} value={form.receiverRequest} type="text" name='receiverRequest' placeholder='요청사항'/>
        </div>
      </div>
      {<>
